...
<body>
	...
	<ul >
			...
			<div id="main">
				<div id="main2"></div>
			<h2>Mr Praful Gabhane</h2>
				
				    <!--img id="image2" src="C:\Users\Praful Gabhane\Desktop\r.jpg" align="left"-->

			    <p> I am pursuing B.E in Computer Science and Engineering from Government College of Engineering, Chandrapur. I had completed my diploma in Information Technology from Vivekanannd Polytechnic Sitasaongi.
